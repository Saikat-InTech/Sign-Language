export const four = (ref) => {
    ...
    // Fold thumb (represented by keeping other fingers straight)
    // Keep index, middle, ring, and pinky straight
    ...
    animations.push(["mixamorigRightHand", "rotation", "z", -Math.PI / 16, "-"]);
